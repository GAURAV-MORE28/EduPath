...
SKILLS = [
    ...
    sk("skill.big_o", "Algorithmic Complexity (Big-O)", ["time complexity", "space complexity", "Big-O", "Big O"],
    ...
    sk("skill.linear_algebra_matrices", "Matrices & Matrix Operations", ["matrix multiplication", "matrices"],
    ...
    # -- ML fundamentals --
    sk("skill.ml_fundamentals", "Machine Learning Fundamentals", ["intro to machine learning", "machine learning"],
    ...
    sk("skill.rest_api_design", "REST API Design", ["RESTful APIs", "REST API", "REST APIs"],
    ...
    sk("skill.kubernetes_basics", "Kubernetes Basics", ["K8s", "Kubernetes"],
       "devops_infrastructure", "concept", "Orchestrating containers at scale with Kubernetes."),
    sk("skill.ci_cd", "CI/CD Pipelines", ["continuous integration", "continuous deployment", "CI/CD"],
       "devops_infrastructure", "practice", "Automating build, test and deployment pipelines."),
    sk("skill.cloud_fundamentals", "Cloud Computing Fundamentals", ["AWS basics", "cloud services", "AWS"],
    ...
    sk("skill.infrastructure_as_code", "Infrastructure as Code", ["Terraform basics", "Terraform"],
...
DEMO_LEARNER_STATE = {
    ...
    "skill_states": [
        ...
        {
            "skill_id": "skill.algebra_basics", "status_for_role": "UNVERIFIED", "target_level": 1,
            "mastery": {"alpha": 1.0, "beta": 1.0, "estimate": 0.5, "band": "Unknown", "confidence": "low",
                        "n_obs": 0},
            "tier_max": "E1", "claims": ["Calculus I & II coursework presupposes algebra (listed on resume)."],
            "evidence": [{"evidence_id": "ev.asha.algebra_basics.coursework", "tier": "E1",
                          "source_type": "document", "note": "Calculus I & II coursework presupposes algebra (listed on resume)."}],
        },
        {
            "skill_id": "skill.functions_graphs_math", "status_for_role": "UNVERIFIED", "target_level": 1,
            "mastery": {"alpha": 1.0, "beta": 1.0, "estimate": 0.5, "band": "Unknown", "confidence": "low",
                        "n_obs": 0},
            "tier_max": "E1", "claims": ["Calculus I & II coursework presupposes functions and graphs (listed on resume)."],
            "evidence": [{"evidence_id": "ev.asha.functions_graphs_math.coursework", "tier": "E1",
                          "source_type": "document", "note": "Calculus I & II coursework presupposes functions and graphs (listed on resume)."}],
        },
        {
            "skill_id": "skill.calculus_limits", "status_for_role": "UNVERIFIED", "target_level": 1,
            "mastery": {"alpha": 1.0, "beta": 1.0, "estimate": 0.5, "band": "Unknown", "confidence": "low",
                        "n_obs": 0},
            "tier_max": "E1", "claims": ["Calculus I & II coursework (listed on resume)."],
            "evidence": [{"evidence_id": "ev.asha.calculus_limits.coursework", "tier": "E1",
                          "source_type": "document", "note": "Calculus I & II coursework (listed on resume)."}],
        },
        {
            "skill_id": "skill.derivatives", "status_for_role": "UNVERIFIED", "target_level": 1,
            "mastery": {"alpha": 1.0, "beta": 1.0, "estimate": 0.5, "band": "Unknown", "confidence": "low",
                        "n_obs": 0},
            "tier_max": "E1", "claims": ["Calculus I & II coursework (listed on resume)."],
            "evidence": [{"evidence_id": "ev.asha.derivatives.coursework", "tier": "E1",
                          "source_type": "document", "note": "Calculus I & II coursework (listed on resume)."}],
        },
        {
            "skill_id": "skill.multivariable_calculus", "status_for_role": "UNVERIFIED", "target_level": 1,
            "mastery": {"alpha": 1.0, "beta": 1.0, "estimate": 0.5, "band": "Unknown", "confidence": "low",
                        "n_obs": 0},
            "tier_max": "E1", "claims": ["Calculus II coursework (listed on resume)."],
            "evidence": [{"evidence_id": "ev.asha.multivariable_calculus.coursework", "tier": "E1",
                          "source_type": "document", "note": "Calculus II coursework (listed on resume)."}],
        },
        {
            "skill_id": "skill.linear_algebra_vectors", "status_for_role": "UNVERIFIED", "target_level": 1,
            "mastery": {"alpha": 1.0, "beta": 1.0, "estimate": 0.5, "band": "Unknown", "confidence": "low",
                        "n_obs": 0},
            "tier_max": "E1", "claims": ["Linear Algebra coursework (listed on resume)."],
            "evidence": [{"evidence_id": "ev.asha.linear_algebra_vectors.coursework", "tier": "E1",
                          "source_type": "document", "note": "Linear Algebra coursework (listed on resume)."}],
        },
        {
            "skill_id": "skill.linear_algebra_matrices", "status_for_role": "UNVERIFIED", "target_level": 1,
            "mastery": {"alpha": 1.0, "beta": 1.0, "estimate": 0.5, "band": "Unknown", "confidence": "low",
                        "n_obs": 0},
            "tier_max": "E1", "claims": ["Linear Algebra coursework (listed on resume)."],
            "evidence": [{"evidence_id": "ev.asha.linear_algebra_matrices.coursework", "tier": "E1",
                          "source_type": "document", "note": "Linear Algebra coursework (listed on resume)."}],
        },
        {
            "skill_id": "skill.activation_functions", "status_for_role": "UNVERIFIED", "target_level": 1,
            "mastery": {"alpha": 1.0, "beta": 1.0, "estimate": 0.5, "band": "Unknown", "confidence": "low",
                        "n_obs": 0},
            "tier_max": "E1", "claims": ["Introduction to Machine Learning coursework (listed on resume)."],
            "evidence": [{"evidence_id": "ev.asha.activation_functions.coursework", "tier": "E1",
                          "source_type": "document", "note": "Introduction to Machine Learning coursework (listed on resume)."}],
        },
        {
            "skill_id": "skill.optimization_basics", "status_for_role": "UNVERIFIED", "target_level": 1,
            "mastery": {"alpha": 1.0, "beta": 1.0, "estimate": 0.5, "band": "Unknown", "confidence": "low",
                        "n_obs": 0},
            "tier_max": "E1", "claims": ["Introduction to Machine Learning coursework (listed on resume)."],
            "evidence": [{"evidence_id": "ev.asha.optimization_basics.coursework", "tier": "E1",
                          "source_type": "document", "note": "Introduction to Machine Learning coursework (listed on resume)."}],
        },
        {
            "skill_id": "skill.python_data_structures", "status_for_role": "UNVERIFIED", "target_level": 1,
            "mastery": {"alpha": 1.0, "beta": 1.0, "estimate": 0.5, "band": "Unknown", "confidence": "low",
                        "n_obs": 0},
            "tier_max": "E1", "claims": ["Data Structures and Algorithms coursework (listed on resume)."],
            "evidence": [{"evidence_id": "ev.asha.python_data_structures.coursework", "tier": "E1",
                          "source_type": "document", "note": "Data Structures and Algorithms coursework (listed on resume)."}],
        },
        {
...
DEMO_SCENARIO = {
    ...
    "seeded_item_set": {
        ...
        "misconception_tagged_items": ["item.backpropagation.3", "item.chain_rule.3", "item.chain_rule.4"],
    },
    "scripted_attempt": {
        "description": "Scripted-wrong-answer button per §38.2 step 8: answers the misc.chain_rule_sum-tagged "
                        "*wrong* option on backpropagation.3 and on both chain_rule prerequisite-block items "
                        "(3 tagged occurrences, chain_rule block 0/2), and answers the other backpropagation "
                        "items correctly so no competing misconception is detected. Every chosen distractor "
                        "exists in data/dataset/assessment_items.json (validate_dataset.py checks this).",
        "answers": [
            {"item_id": "item.backpropagation.1", "chosen_is_key": True, "chosen_misconception_id": None},
            ...
            {"item_id": "item.backpropagation.4", "chosen_is_key": True, "chosen_misconception_id": None},
    ...
    "expected_reflection_operators": ["INSERT_REMEDIATION", "ADD_PROBE"],
    # DEFER only fires when the struggling skill has an item scheduled this week. For this persona
    # backpropagation is BLOCKED behind neural_network_fundamentals/linear_algebra_matrices, so the
    # Planner (correctly) never schedules it and there is nothing to defer.
    "optional_reflection_operators": ["DEFER"],
